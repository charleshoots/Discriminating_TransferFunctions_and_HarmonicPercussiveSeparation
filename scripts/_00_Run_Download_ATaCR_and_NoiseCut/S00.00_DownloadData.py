...
## =============================================================================== ##
# 00_AutoRunDownload:
# This simple script is set up as to delgate tasks to the download steps built directly 
# into ATaCR. This script capable of doing every step in ATaCR but the settings below will 
# restrict it to just the download steps such that they can be used with either ATaCR
# or NoiseCut
## =============================================================================== ##
