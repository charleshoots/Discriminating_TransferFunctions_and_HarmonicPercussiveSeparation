...
# if mtrsets=='R.vs.SNR':
#     axes.reshape(-1)[1:][-1].sharex(axes.reshape(-1)[1:][-2])
#     axes.reshape(-1)[1:][-2].sharex(axes.reshape(-1)[1:][-3])
# else:
#     axes.reshape(-1)[1:][-1].sharex(axes.reshape(-1)[1:][-2])
#     axes.reshape(-1)[1:][-2].sharex(axes.reshape(-1)[1:][-3])

#     axes.reshape(-1)[1:][-1].sharey(axes.reshape(-1)[1:][-2])
#     axes.reshape(-1)[1:][-2].sharey(axes.reshape(-1)[1:][-3])
